...
function Registerars() {
  ...
  const filtered = ()=>{
    return users.filter(e=> e?.name?.toLowerCase().includes(filter.toLowerCase()) || e?.email?.toLowerCase().includes(filter.toLowerCase()) || e?.college?.name?.toLowerCase().includes(filter.toLowerCase()))
  }
        ...
        <Col lg="12" md="12">
          <Card>
            <CardHeader className="d-flex justify-content-between">
              <CardTitle tag="h4">Registerars</CardTitle>
